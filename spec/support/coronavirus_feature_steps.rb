...
module CoronavirusFeatureSteps
  ...
  def then_i_see_the_timeline_entry_form
    expect(page).to have_text(I18n.t("coronavirus.pages.timeline_entries.form.heading"))
    expect(page).to have_text(I18n.t("coronavirus.pages.timeline_entries.form.content"))
  end
