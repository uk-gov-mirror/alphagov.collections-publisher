module Coronavirus
  class ReorderAnnouncementsController < ApplicationController
    ...
    def update
      ...
      if success
        message = I18n.t("coronavirus.reorder_announcements.controller.reorder_success")
        redirect_to coronavirus_page_path(page.slug), notice: message
      else
        message = I18n.t("coronavirus.reorder_announcements.controller.reorder_failed", error: draft_updater.errors.to_sentence)
